...
Here I am showing installation of openMPI with homebrew and HDF5 and HYPRE from cloning of git. In this case openMPI is in /opt/homebrew/Cellar. HDF5 and Hypre are in /usr/local/flash-deps. 
